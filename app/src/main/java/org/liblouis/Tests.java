...
import static org.liblouis.Louis.getBrailleTranslation;
import static org.liblouis.Louis.getTextTranslation;
...
public class Tests {
    ...
    public static void translateText(TranslationTable table, CharSequence text) {
        ...
        BrailleTranslation brl = getBrailleTranslation(table, text);
        CharSequence braille = brl.getBrailleWithSpans();
        Log.d(LOG_TAG, ("braille translation: " + braille));
        logOffsets(brl);

        TextTranslation txt = getTextTranslation(table, braille);
